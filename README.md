...
| 生態保育措施 | `src/content/ecoplan.md`、`public/images/ecological-measures/` | 每個 `##` 是一項主要措施頁籤，`###` 為內容區塊標題。清單若使用「標籤：內容」，前段會顯示為膠囊標籤。圖檔放置與中文命名完整步驟請見 `public/images/ecological-measures/README.md`。 |
...
| `/plants` | `PlantingSuggestion` | 生態保育措施 |
