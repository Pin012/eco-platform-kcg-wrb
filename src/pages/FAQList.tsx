            ...
            >
              <div className="mb-4">
                <h3 className="text-xl font-bold text-[#1B3022] flex items-center gap-2 mb-1">
                  <span className="w-1.5 h-5 bg-[#588157] rounded-sm"></span> {category.title}
              ...
              <div className="space-y-3">
                {category.items.map((item, itemIdx) => {
                  ...
                  return (
                    <div 
                      key={itemIdx} 
                      className={`bg-white rounded-xl border transition-all duration-200 ${isOpen ? 'border-[#A3B18A] shadow-md' : 'border-[#D8E2DC] shadow-sm hover:border-[#A3B18A]'}`}
                    >
                      <button 
