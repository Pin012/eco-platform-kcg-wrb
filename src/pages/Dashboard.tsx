      ...
      <div className="flex-1 grid grid-cols-2 lg:grid-cols-[repeat(13,minmax(0,1fr))] gap-2.5 sm:gap-3 pb-2">
        ...
        >
          ...
          <div className="flex flex-col items-center sm:items-start gap-1 sm:gap-0 w-full">
            ...
            <div className="flex-1 flex flex-col items-center sm:items-start justify-center sm:justify-between w-full text-center sm:text-left">
              <div className="flex flex-col items-center sm:items-start w-full">
                <h3 className="font-bold text-[13px] sm:text-sm text-[#1B3022] sm:mb-1 tracking-tight leading-tight">{modIssues.title}</h3>
                <p className="hidden sm:block text-xs text-gray-500 leading-snug mb-3 hover:text-gray-700">
                  {modIssues.description}
                </p>
                <div className="hidden sm:flex flex-wrap gap-1.5 text-[10px] font-bold text-gray-600">
          ...
          <div className="hidden sm:flex mt-3 justify-end w-full">
            <span className="inline-flex items-center gap-1.5 px-2.5 py-1.5 bg-[#FBFBFB] border border-[#D8E2DC] text-[#344E41] text-[10px] font-bold rounded-lg group-hover:bg-[#F2F5F0] transition-colors ml-auto">
        ...
        >
           ...
           <div className="relative z-10 flex flex-col items-center sm:items-start gap-1 sm:gap-0 w-full">
             ...
             <div className="flex-1 flex flex-col items-center sm:items-start justify-center sm:justify-start w-full text-center sm:text-left">
               <div className="flex flex-col items-center sm:items-start w-full">
                 <h3 className="font-bold text-[13px] sm:text-sm text-white sm:mb-1.5 tracking-tight drop-shadow-md leading-tight">{modMap.title}</h3>
                 <p className="hidden sm:block text-xs text-white/90 leading-snug max-w-sm mb-3 drop-shadow-md font-medium">
                   {modMap.description}
                 </p>
                 <div className="hidden sm:flex flex-wrap gap-1.5 text-[10px] font-bold text-white/90">
           ...
           <div className="hidden sm:flex mt-3 justify-end relative z-10 w-full">
             <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#588157]/60 backdrop-blur-md border border-white/20 text-white text-[10px] font-bold rounded-lg shadow-sm group-hover:bg-[#588157]/80 transition-colors ml-auto">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center sm:items-start gap-1 sm:gap-0 w-full">
            ...
            <div className="flex-1 flex flex-col items-center sm:items-start justify-center sm:justify-between w-full text-center sm:text-left">
               <div className="flex flex-col items-center sm:items-start w-full">
                 <h3 className="text-white font-bold text-[13px] sm:mb-1 flex items-center justify-center sm:justify-start flex-wrap gap-1.5 transition-transform group-hover:translate-x-1 duration-300 leading-tight">
                 ...
                 <p className="hidden sm:block text-[#A3B18A] text-[10px] leading-snug line-clamp-2 transition-transform group-hover:translate-x-1 duration-300 delay-50">
          ...
          <div className="hidden sm:flex mt-3 justify-end relative z-10 w-full">
            <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#A3B18A] group-hover:bg-[#FFD700] text-[#1B3022] font-bold text-[10px] rounded-lg transition-all shadow-sm ml-auto mt-1 sm:mt-0 group-hover:scale-105 group-hover:shadow-[0_0_10px_rgba(255,215,0,0.3)]">
        ...
        >
          <HelpCircle className="absolute hidden sm:block -right-4 top-1/2 -translate-y-1/2 w-56 h-56 lg:w-64 lg:h-64 text-[#588157] opacity-[0.04] pointer-events-none transform rotate-12 group-hover:scale-110 group-hover:rotate-[20deg] transition-all duration-500" />
           <div className="flex flex-col items-center sm:items-start gap-1 sm:gap-0 w-full">
             ...
             <div className="flex-1 flex flex-col items-center sm:items-start justify-center sm:justify-between w-full text-center sm:text-left">
               <div className="flex flex-col items-center sm:items-start w-full">
                 <h3 className="text-[#1B3022] font-bold text-[13px] sm:mb-1 leading-tight">{modFaq.title}</h3>
                 <p className="hidden sm:block text-gray-500 text-[10px] leading-snug mb-2.5 line-clamp-2">
                   {modFaq.description}
                 </p>
                 <div className="hidden sm:flex flex-wrap gap-1 text-[8px] font-bold text-gray-500">
           ...
           <div className="hidden sm:flex mt-3 items-center justify-end w-full">
             <div className="text-[10px] font-bold text-[#588157] flex items-center group-hover:translate-x-1 transition-transform ml-auto">
        ...
        >
           <div className="relative z-10 flex flex-col items-center sm:items-start gap-1 sm:gap-0 w-full">
             ...
             <div className="flex-1 flex flex-col items-center sm:items-start justify-center sm:justify-between w-full text-center sm:text-left">
               <div className="flex flex-col items-center sm:items-start w-full">
                 <h3 className="font-bold text-[13px] sm:mb-1 text-[#1B3022] leading-tight">{modPlants.title}</h3>
                 <p className="hidden sm:block text-[#3A5A40] text-[10px] leading-snug mb-2.5 line-clamp-2 font-medium">
                   {modPlants.description}
                 </p>
                 <div className="hidden sm:flex flex-wrap gap-1 text-[8px] font-bold text-[#2D4A32]">
           ...
           <div className="hidden sm:flex mt-3 items-center justify-end relative z-10 w-full">
             <div className="text-[10px] font-bold text-[#1B3022] flex items-center group-hover:translate-x-1 transition-transform ml-auto">
